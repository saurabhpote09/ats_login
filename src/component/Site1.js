          ...
          <table className="min-w-full bg-white">
            <thead>
              <tr className="bg-[#F7F7F8]">
                ...
                <th className="font-semibold text-sm p-2 text-center w-[10%]">WordPress</th>
                <th className="font-semibold text-sm p-2 text-center w-[10%]">Plugins</th>
                <th className="font-semibold text-sm p-2 text-center w-[10%]">Themes</th>
                <th className="font-semibold text-sm p-2 text-start w-[20%]">Last Syn</th>
                <th className="font-semibold text-sm p-2 text-start w-[15%]">Site Health</th>
                <th className="font-semibold text-sm p-2 text-start w-[10%]">Status Code</th>
                <th className="font-semibold text-sm p-2 text-start w-[12%]">Connected</th>
            ...
            <tbody>
                ...
                <tr className={`bg-white border-b border-[#EAEAEA]`}>
                  ...
                  <div className='px-4 py-[6px] text-white bg-black text-center m-auto w-12 h-7 rounded'>0</div>
                  </td>
                  <td className="font-normal text-sm leading-4 p-3">
                  <div className='px-4 py-[6px] text-white bg-[#F9B023] text-center m-auto w-12 h-7 rounded'>0</div>
                  </td>
                  <td className="font-normal text-sm leading-4 p-3">
                  <div className='px-4 py-[6px] text-white bg-[#00B656] text-center m-auto w-12 h-7 rounded'>0</div>

                  </td>
                  <td className="font-normal text-sm leading-4 p-3">May 24, 2024 - 4:52 PM</td>
                  <td className="font-normal text-sm leading-4 p-3 ">
