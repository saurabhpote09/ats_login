  ...
  return (
    <header className="flex flex-wrap justify-between items-center w-full p-4 border-b ">
      <div className="flex items-center mb-1 md:mb-0 gap-x-10 gap-y-4 lg:gap-[131px] w-full flex-wrap md:flex-nowrap md:w-[40%]">
        <div className="flex items-center gap-4 md:gap-[26px]">
          <img
            ...
            className="w-5 h-5 md:w-auto md:h-auto cursor-pointer"
            onClick={() => {
      ...
      <div className="flex items-center justify-end gap-2 lg:gap-4 w-full md:w-auto">
        <img src={search} alt="Search" className=" sm:block" />
        <img
          src={notification}
          alt="Notifications"
          className=" sm:block"
        />
        <img src={restart} alt="Restart" className=" sm:block" />
        <img src={question} alt="Help" className=" sm:block" />
        <img src={bell} alt="Alerts" className=" sm:block" />
        <img src={add} alt="Add" className=" sm:block" />
