...
const Client = () => {
  ...
  const clients = [
    ...
    {
      email: "marksmith+testing@gmail.com",
      name: "Mark Smith",
      role: "Client",
      status: "Invited",
    ...
    {
      email: "jamesmark+testing@gmail.com",
      name: "James Mark",
      role: "Client",
      status: "Invited",
      created: "July 20, 2024",
    ...
    {
      email: "lizawarner+testing@gmail.com",
      name: "Liza Warner",
      role: "Client",
      status: "Invited",
      created: "July 20, 2024",
    ...
    {
      email: "sandssmith+testing@gmail.com",
      name: "Sands Smith",
      role: "Client",
      status: "Invited",
      created: "July 18, 2024",
    ...
    {
      email: "kimsmith+testing@gmail.com",
      name: "Kim Smith",
      role: "Client",
      status: "Invited",
      created: "July 18, 2024",
    ...
    {
      email: "smithp+testing@gmail.com",
      name: "Smith P.",
      role: "Client",
      status: "Invited",
    ...
    {
      email: "joesmith+testing@gmail.com",
      name: "Joe Smith",
      role: "Client",
      status: "Invited",
      created: "July 16, 2024",
  ...
  const filteredClients = clients.filter(
    (client) =>
      ...
      client.created.toLowerCase().includes(searchQuery.toLowerCase())
  );
            ...
            <thead>
              <tr className="bg-[#F7F7F8]">
                <th className="p-2 w-[5%]">
                  <input
                    type="checkbox"
                    className="size-4 border rounded border-[#EAEAEA] focus:ring-transparent"
                  />
                </th>
                {columns.Email && (
                  <th className="font-semibold text-sm p-2 text-start w-[25%]">
                    Email
                  </th>
                )}
                {columns.Client && (
                ...
                {columns.Action && (
                  <th className="font-semibold text-sm p-2 text-center w-[12%]">
                    Action
                  </th>
                )}
                ...
                filteredClients.map((client, index) => (
                  ...
                  >
                   ...
                   }
                   {
                    ...
                    <td className="font-normal text-sm leading-4 p-3 flex justify-center">
                      <img
                        src={refresh}
                        alt="Refresh"
